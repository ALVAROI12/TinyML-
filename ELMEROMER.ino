...
String AP = "uiw-resnet";       // AP NAME
String PASS = "";        // We write the password of our network here.

int rxPin = 12;                                               //ESP8266 RX pini
int txPin = 13;                                               //ESP8266 TX pini
int dht11Pin = 2;
...
void setup() {  
  ...
  esp.println("AT+CWJAP=\""+AP+"\",\""+PASS+"\"");    // We are connecting to our network.
